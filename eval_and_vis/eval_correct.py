...
detected_origin_path = 'checkpoints/precls_motif/inference/VG_stanford_filtered_with_attribute_test/'
detected_origin_result = torch.load(detected_origin_path + 'eval_results.pytorch')
detected_attri_path = 'checkpoints/precls_motif_frame/inference/VG_stanford_filtered_with_attribute_test/'
